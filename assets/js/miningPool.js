...
function createHistogram(g, poolName, poolData, color) {
    ...
    // let newData = [
    //     {date : "2023-01", value : 2},
    //     {date : "2023-08", value : 2},
    //     {date : "2023-08", value : 3.5},
    ...
    const yAxisGroupRight = g.append('g')
        ...
        .call(d3.axisRight(yScaleRight).ticks(1));
    ...
    yAxisGroupRight.selectAll('text').style('font-size', '0.8em')
